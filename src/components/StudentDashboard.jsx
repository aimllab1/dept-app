      ...
      <main className="max-w-5xl mx-auto py-8 px-6 space-y-8">
        <div className="bg-white p-4 sm:p-6 rounded-[2.5rem] border border-gray-100 shadow-xl space-y-4">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 pt-2">
            <h3 className="text-[11px] font-black text-gray-500 uppercase tracking-widest">Current Semester View</h3>
        ...
        {activeTab === 'overview' && (
          <div className="space-y-8">
              ...
              <div className="bg-white shadow-2xl rounded-[3rem] p-8 border border-gray-100 text-left">
                ...
                <div className="mt-6 grid grid-cols-2 gap-4">
                  <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100">
                    <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest">Present + OD</p>
                    <p className="text-2xl font-black text-gray-900 mt-1">{attendanceStats.present + attendanceStats.od}</p>
                  </div>
                  <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100">
                    <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest">Working Days</p>
                    <p className="text-2xl font-black text-gray-900 mt-1">{attendanceStats.totalWorkingDays}</p>
                  </div>
                </div>
              </div>
                ...
                {latestMarkUpdate ? (
                  <div className="mt-6 space-y-4">
                    ...
                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">
                      Updated: {latestMarkUpdate.updatedAt ? new Date(latestMarkUpdate.updatedAt).toLocaleString() : 'N/A'}
                    </p>
                  </div>
                ) : (
                  <div className="mt-8 p-8 bg-gray-50 rounded-2xl border border-gray-100 text-center">
                    <p className="text-[10px] font-black text-gray-300 uppercase tracking-widest">No marks updated yet</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="bg-white shadow-2xl rounded-[3rem] p-8 border border-gray-100">
              <h3 className="text-lg font-black text-gray-900 uppercase tracking-widest mb-6">Attendance Calendar</h3>
          ...
          <div className="bg-white shadow-2xl rounded-[3rem] p-10 border border-gray-100 relative overflow-hidden text-left">
            ...
            <div className="bg-white p-8 rounded-[2.5rem] border-2 border-gray-50 flex items-center justify-between mb-10 relative z-10 shadow-sm">
              ...
              <div className="text-right">
                ...
                <span
                  className={`text-[10px] font-black uppercase px-4 py-2 rounded-full ${
                    parseFloat(attendanceStats.percentage) < 75 ? 'bg-rose-50 text-rose-600' : 'bg-emerald-50 text-emerald-600'
                  }`}
                >
        ...
        {activeTab === 'analytics' && (
          <div className="bg-white shadow-2xl rounded-[3rem] p-10 border border-gray-100 overflow-hidden animate-fade-in text-left">
            ...
            <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-6">X Axis: Tests • Y Axis: Score (0 to 100)</p>
              ...
              {currentSemesterSubjects.length === 0 ? (
                ...
                currentSemesterSubjects.map((sub) => (
                  <button
                    ...
                    className={`p-6 rounded-2xl border-2 transition-all flex justify-between items-center group text-left ${
                      selectedSubjectForChart?._id === sub._id
                        ? 'border-blue-600 bg-blue-50'
                        : 'bg-gray-50 border-transparent hover:border-blue-600 hover:bg-white'
                    }`}
                  >
                    <div className="text-left">
